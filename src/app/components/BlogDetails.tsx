  ...
  return (
    <div className='mt-4 mb-12'>
      ...
      <div className='mt-5'>
        ...
        <Image src={urlFor(data.titleImage).url()} alt='title image' width={500} height={500} className='w-full h-[500px] object-fill border rounded-lg mt-6' priority unoptimized />
