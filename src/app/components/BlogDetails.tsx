...
const BlogDetails = ({data} : BlogDetailProps) => {
  return (
    <div className='mt-4 mb-12'>
      ...
      <div className='mt-5'>
        <h1 className='lg:text-5xl text-3xl font-bold text-center'>{data.title}</h1>
        <Image src={urlFor(data.titleImage).url()} alt='title image' width={500} height={500} className='w-full border rounded-lg mt-6' priority />
